...
<details>
<summary>新增功能 (2026-03-26)</summary>

- 支持拖拽/粘贴上传多格式文件（PDF、MP3、MP4、WAV、DOC、DOCX、XLS、XLSX、PPT、PPTX、ZIP、MOV、WebM）

- 新增**手动上传模式**：默认不自动上传，拖拽/粘贴仅插入本地链接，可右键选择「上传附件到COS」手动上传
...
- 支持拖拽、复制粘贴上传图片
- 自动替换本地图片链接为云端链接
- 支持**手动上传模式**：可选择仅插入本地链接，手动右键上传指定附件
...
1. 在插件设置中开启 **"手动上传模式"** 开关
2. 拖拽或粘贴文件时，仅插入本地附件链接（不自动上传）
3. 在笔记中选中需要上传的附件链接文本
4. 右键选择 **"上传附件到COS"**
5. 插件会识别选中的本地附件，上传到COS并替换为云端链接
6. 支持同时选中多个附件链接批量上传
